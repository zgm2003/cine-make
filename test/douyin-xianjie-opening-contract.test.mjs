...
const source = [
  ...
  '林夜想到用娱乐拖住正魔两道修士的修炼和厮杀，一次买下一万部手机，骑幽冥虎王前往奼女教。',
  '奼女教教主白清玄误会林夜来双修。林夜分发手机，教女修打开抖音、拍摄、发布、加音乐特效。',
...
test('抖音仙界开局 Seedance feed uses dedicated 3D guoman opening profile', () => {
  ...
  assert.equal(pack.videoLines.length, 15)
  ...
  assert.match(markdown, /### 第3组｜第11-15条/)
  ...
  assert.match(markdown, /上传参考图：鬼王宗宗门大殿 = 图片1；林夜 = 图片3/)
