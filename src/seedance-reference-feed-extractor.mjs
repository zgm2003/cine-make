...
function snowQilinVideoLines() {
  return [
    ...
    '雪山之巅（日外） 鲜血一滴滴落在白雪上，暗红色在雪粒之间慢慢扩散，道清模糊背影还在远处艰难移动，身后留下长长血痕。贴地特写 + 血滴占画面下方中心 + 道清背影压在远处雪线 + 纵向血痕引导视线。镜头后移（展示人物孤独）。音效：血滴落雪、风声更重。',
    '雪山之巅（日外） 道清膝盖突然发软，身体向前一沉，斗笠歪斜，双臂仍本能地把麒麟幼兽往怀里护紧。半身近景 + 失衡构图 + 蓑衣边缘积雪抖落。手持拍摄（轻微晃动增加真实紧张）。环境音：沉重喘息、风雪拍打蓑衣。',
    '雪山之巅（日外） 道清终于支撑不住，身体倒进雪地，怀里的麒麟幼兽被甩出一小段距离，滚到画面下方雪地里，雪粉溅起后落下。全景 + 道清倒在画面上方雪线 + 麒麟滚停在画面下方中心 + 距离关系清楚。镜头下降（从站立失衡压向倒地）。音效：身体砸进雪地的闷响，麒麟短促弱鸣。',
    '雪山之巅（日外） 麒麟幼兽趴在雪地里，艰难抬头看向远处倒下的道清，眼中含泪，细小麟角沾着雪粒。麒麟脸部特写 + 低机位 + 远处道清模糊可见 + 冷蓝灰反光。变焦推进（突出含泪表情反应）。音效：麒麟低弱鸣咽。',
    ...
    '雪山之巅（日外） 道清奄奄一息地触摸麒麟幼兽的额角，麒麟幼兽低头贴近他的手，老人、幼兽、血痕和风雪都保持安静克制。近景关系镜头 + 斗笠阴影遮半脸 + 幼兽微弱青金反光落在老人手背。镜头前推（缓慢靠近最终触碰）。环境音：寒风、细雪摩擦蓑衣、麒麟极轻的喘息，无对白。'
  ]
}
