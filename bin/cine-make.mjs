...
function usage() {
  return [
    ...
    '  cine-make [seedance-pack] [--out <output-dir>] [--input <file>] [--aspect <16:9|9:16|1:1>] [--style <style>] "<story material>"',
    '  cine-make reference-feed [--out <output-dir>] [--input <file>] [--aspect <16:9|9:16|1:1>] [--style <style>] "<story material>"',
    ...
    '',
    'Default output: ChatGPT-only Seedance all-reference feed in the calling project runs/ folder. Canvas and draft/visual user modes are removed.',
    '',
    'Install examples:',
