...
function usage() {
  return [
    ...
    '  cine-make canvas-pack --out <output-dir> [--input <file>] [--aspect <9:16|16:9|1:1>] [--style <style>] "<story material>"',
    ...
    '',
    'Default output: Seedance all-reference feed + media-free Canvas import pack. draft/visual user modes are removed.',
    '',
    'Install examples:',
